              ...
              <div class="box-body">
                ...
                <?php echo form_open('product/save_product'); ?>
                    ...
                    <select class="form-control" name="kode">
                      ...
                      <option value="BOPIS001">BOPIS001- Paket Bolu Pisang</option>
                      <option value="LTB002">LTB002 - Paket Lapis Talas</option>

                    </select>
										
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Nama Bahan Paketan</label>
										<input type="text" class="form-control" name="nmproduk" />
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Deskripsi Bahan</label>
