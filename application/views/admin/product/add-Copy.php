		...
		<div class="box box-info">
			...
			<div class="box-header">
				<div class="form-group">
					...
					<input readonly type="text" class="form-control" name="productName" value="<?=  $produk->productBarcode.' - '. $produk->productName ?>" /><input  type="hidden" class="form-control" name="productBarcode" value="<?= $produk->productBarcode ?>" />
				</div>
				
				<div class="form-group">
					<input type="hidden" name="id" >
					<label for="exampleInputEmail1">Jumlah Yang dibuat</label>
					<input readonly type="text" class="form-control" name="productQTY" value="<?= $jum_pro ?>" />
				</div>
			</div>
			<div class="box-body">
				<div class="col-md-12">
					...
					<div class="col-md-6">
						<div class="form-group has-warning">
							...
							<input type="hidden" class="form-control" name="produksiID" value="<?= $produksiID ?>" />
							...
							<input type="hidden" class="form-control" name="jum_pro" value="<?= $jum_pro ?>" />
							<input type="hidden" class="form-control" name="barcode_pro" value="<?= $barcode_pro ?>" />
						</div>
					</div>
					<div class="col-md-2">
						<div class="form-group">
