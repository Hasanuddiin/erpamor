        ...
        <!-- Content Header (Page header) -->
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="<?php echo base_url(); ?>admin/satuan"> <?php echo $title; ?></a></li>
          ...
          <section class="content">
            <div class="box box-info">
              ...
              <div class="box-body">
                ...
                <!-- form start -->
                <?php echo form_open('admin/update_satuan'); ?>
                <?php  
                foreach ($editdata as $data):
                ?>
									<div class="form-group">
										<input type="hidden" name="id" value="<?php echo $data->satuanID ?>">
										<label for="exampleInputEmail1">Nama Satuan</label>
										<input type="text" class="form-control" name="name" value="<?php echo $data->satuanName; ?>" />
									</div>
