  ...
  <section class="content">
  	<div class="box box-info">
  		...
  		<div class="box-body">
  			...
  			<?php echo form_open('admin/addtpj_nonmemberdetail_edit/?nofak='.$trxid.'&tgltrx='.$trxDate.'',$attribute); ?>
  			<div class="col-md-2">
  								...
  								<tbody>
  									...
  									<tr class="gradeU">
  											...
  											else if($r->productDiscounttype=="2")
  											{
  												...
  												<td>
  													<div class="btn-group" role="group">
  														...
  														<a href="<?php echo base_url(); ?>admin/hapus_trxpjnonmember_edit?idtrxpj=<?php echo $r->detailID ?>&productBarcode=<?php echo $r->productBarcode; ?>&qtyremove=<?php echo $r->detailQty ?>&nofak=<?php echo $trxid;?>&tgltrx=<?php echo $trxDate; ?>" onclick="javascript: return confirm('Anda akan menghapus item : <?php echo $r->productName; ?> ?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus</a>
  													</div>
  												</td>
  											</tr>
  											<?php 
  										...
  										<tr class="gradeA">
  											...
  											<div class="col-md-2">
  												<div class="form-groupb has-warningb">
  													<b>TOTAL HARGA</b><input type="text" class="form-control" name="total" value="<?php $total_harga = $total; echo number_format($total_harga, 0, '.', ',');?>" id="total"  readonly/>
  												</div>
  											</div>
  											<div class="col-md-2">
  												<div class="form-groupb has-warningb">
  	...
  	<div id="dialog" style="display: none" align = "center">
  		<!-- form start -->
  		<?php echo form_open('admin/addtpj_nonmemberdetail_edit/?nofak='.$trxid.'&tgltrx='.$trxDate.''); ?>
  		<div class="form-group">
  		...
  		<div class="form-group">
  			...
  			<input type="text" class="form-control" name="harpro" id="harpro"/>
  		</div>
  		<div class="form-group">
