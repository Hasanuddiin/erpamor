          	...
          	<div class="col-xs-12">
               ...
               <div class="info-box bg-yellow">
                ...
                <div class="info-box-content">
                  <span class="info-box-number"><a href="<?php echo base_url(); ?>admin/showrekapstoktokopamuruyan"  style="color:#fff;" class="info-box-number" id="showmembertrx"> CEK STOCK TOKO</a></span>
                  <span class="info-box-number">Pamuruyan</span>
                  <div class="progress">
