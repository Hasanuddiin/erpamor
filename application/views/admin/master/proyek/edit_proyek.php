          ...
          <section class="content">
            <div class="box box-info">
              ...
              <div class="box-body">
                ...
                <!-- form start -->
                <?php echo form_open('admin/update_proyek'); ?>
                <?php  
                foreach ($editdata as $data):
                ?>
									<div class="form-group">
										<input type="hidden" name="id" value="<?php echo $data->proyekID ?>">
										<label for="exampleInputEmail1">Kode Proyek</label>
										<input type="text" class="form-control" name="kode" value="<?php echo $data->proyekCode; ?>" />
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Nama Proyek</label>
										<input type="text" class="form-control" name="name" value="<?php echo $data->proyekFullName; ?>" />
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Alamat</label>
										<input type="text" class="form-control" name="address" value="<?php echo $data->proyekAddress; ?>" />
									</div>
									<div class="form-group">
										...
										<select name="zona" class="form-control">
											<?php
											 ...
											 if($zona->zonaName==$data->proyekzone)
											 {
												 ?>
									...
									<div class="form-group">
										<label for="exampleInputEmail1">Telp PIC</label>
										<input type="text" class="form-control" name="phone" value="<?php echo $data->proyekPhone; ?>" />
									</div>
