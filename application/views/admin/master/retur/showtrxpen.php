        		...
        		<table class="table table-bordered table-hover">
        			...
        			<div class="col-md-12">
        				...
        				<table class="table table-bordered table-hover">
        					...
        					<tr>
        						<tr>
        							<td colspan="2"><b>INFORMASI MEMBER</b></td><td colspan="2"></td>
        						</tr>
        						<td>Member</td><td><input type="text" class="form-control" name="supname" value="<?php echo $membersupplier->memberFullName;?>" readonly />
        					</tr>
        					<tr>
        						<td>Alamat</td><td><input type="text" class="form-control" name="supaddress" value="<?php echo $membersupplier->memberAddress;?>" readonly /></td>
        						
        					</tr>
        					<tr>
        						<td>No Telp</td><td><input type="text" class="form-control" name="suptelp" value="<?php echo $membersupplier->memberPhone;?>" readonly /></td>
